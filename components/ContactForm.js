...
const ContactForm = () => {
  ...
  const Success = () => {
    return (
      <div className='  h-2/4 transition-all'>
      ...
      {isSent ? (
        ...
        <div className={styles.contactForm}>
          <form ref={form} onSubmit={sendEmail}>
            <label htmlFor='form_name' className='cursor-pointer'>
              Name
            </label>
            <input
              required
            ...
            />
            <label htmlFor='form_email' className='cursor-pointer'>
              Email
            </label>
            <input
              id='form_email'
            ...
            <label htmlFor='form_mes' className='cursor-pointer'>
              Message
            </label>
            <textarea
              required
